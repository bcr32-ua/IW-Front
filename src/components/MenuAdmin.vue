<template>
    <div class="card bg-secondary" style="max-width: 18rem;">
        <ul class="list-group list-group-flush">
            <a href="/gestionClientes" class="list-group-item list-group-item-action list-group-item-dark"><i class="bi bi-people"></i> Clientes</a>
            <a href="/gestionRecepcion" class="list-group-item list-group-item-action list-group-item-dark"><i class="bi bi-display"></i> Recepcion</a>
